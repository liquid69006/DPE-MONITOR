      ...
      <table style="width:100%;border-collapse:collapse;">
        <thead>
          <tr style="background:#f8fafc;border-bottom:2px solid #e5e7eb;">
            ...
            <th style="padding:12px 20px;text-align:center;font-size:12px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;">Logement</th>
...
def main():
    ...
    resultats_par_zone = {"Part-Dieu": [], "Dauphiné-Lacassagne": [], "Montchat": [], "Autre": []}
